...
class GameBot():
    ...
    def Identify_Player_Possible_Routes(empty, horizontalArray, verticalArray, positiveDiagonalArray, negativeDiagonalArray, playerCoordinate):
        ...
        if len(maximumArray) == 1: # No duplication on the maximum Player's pieces val
            ...
            print("BotInterceptionPoint1:",BotInterceptionPoint1)
            print("BotInterceptionPoint2:",BotInterceptionPoint2)
            
            BotPiecesFinalPlacement = None
            if BotInterceptionPoint1 >= 0:
                print("targetArrayCoordinates[BotInterceptionPoint1]:",targetArrayCoordinates[BotInterceptionPoint1])
                BotPiecesFinalPlacement = targetArrayCoordinates[BotInterceptionPoint1]

            if BotInterceptionPoint2 <= 10:
                print("targetArrayCoordinates[BotInterceptionPoint2]:",targetArrayCoordinates[BotInterceptionPoint2])
                print("BotInterceptionPoint2:", True)
                BotPiecesFinalPlacement = targetArrayCoordinates[BotInterceptionPoint2]

            print("BotPiecesFinalPlacement:",BotPiecesFinalPlacement)
            # Objective: Determine the most opimized coordinate for Bot's piece placement
            return BotPiecesFinalPlacement
        else:
            ...
            if len(minimumBotPiecesArray) > 1:
                ...
                targetArray = []
                targetArrayCoordinates = []
                for coordinates, array in ArraysCoordinates.items(): 
                    if array == minimumBotPiecesArray[0]:
                        targetArray = str(array)
                        targetArrayCoordinates = coordinates

                currentArray = minimumBotPiecesArray[0]
                maximumLength = 0 
                startingPoint = []
                endingPoint = [] 
            ...
            print("BotInterceptionPoint3:",BotInterceptionPoint1)
            print("BotInterceptionPoint4:",BotInterceptionPoint2)
